    ...
    submitHandler = values => {
        if (!this.state.captchaResponse) {
            ...
            const submitData = {
                ...
                durationOfVisit: values.durationOfVisit,
                specialRequest: values.specialRequest
            };

            this.setState(
                { resetCaptcha: true },
                () => postFormData(`/public/activity/email/inquiry/tour-guide?langId=${langId}&g-recaptcha-response=${this.state.captchaResponse}`, submitData, form, 'post', true));
        }
    };
                    ...
                    <div className="greybox activity">
                        ...
                        <div className="row">
                            ...
                            <div className="col-md-6">
                                <div className="form-group">
                                    <label>
                                        <FormattedMessage id="common.date"/> <span
                                        className="required">*</span>
                                    </label>
                        ...
                        <div className="row">
                            <div className="col-md-6">
                                <div className="form-group">
                                    <label>
                                        <FormattedMessage id="inquiry.preferredLanguage"/>{' '}
                                        <span className="required">*</span>
                                    </label>
                            ...
                            <div className="col-md-6">
                                <div className="form-group">
                                    <label>
                                        <FormattedMessage id="inquiry.preferredStyle"/>{' '}
                                        <span className="required">*</span>
                                    </label>
                                    <Field name={`preferredStyle`}
                                           component={AdvancedDropDown}
                                           options={[{
                                               label: intl.formatMessage({ id: 'label.inquiry.preferredStyle.chill.and.easy' }),
                                               value: 'label.inquiry.preferredStyle.chill.and.easy'
                                           }, {
                                               label: intl.formatMessage({ id: 'label.inquiry.preferredStyle.business.visit' }),
                                               value: 'label.inquiry.preferredStyle.business.visit'
                                           }, {
                                               label: intl.formatMessage({ id: 'label.inquiry.preferredStyle.photography.tour' }),
                                               value: 'label.inquiry.preferredStyle.photography.tour'
                                           }, {
                                               label: intl.formatMessage({ id: 'label.inquiry.preferredStyle.nature.tour' }),
                                               value: 'label.inquiry.preferredStyle.nature.tour'
                                           }, {
                                               label: intl.formatMessage({ id: 'label.inquiry.preferredStyle.religious.trip' }),
                                               value: 'label.inquiry.preferredStyle.religious.trip'
                                           }, {
                                               label: intl.formatMessage({ id: 'label.inquiry.preferredStyle.others' }),
                                               value: 'label.inquiry.preferredStyle.others'
                                           }]}
                                           validate={required}
                                           searchable={false}
                                    />
                        ...
                        <div className="row">
                            <div className="col-md-6">
                                <div className="form-group">
                                    <label>
                                        <FormattedMessage id="inquiry.durationOfVisit"/>{' '}
                                        <span className="required">*</span>
                                    </label>
                                    <Field name={`durationOfVisit`}
                                           component={AdvancedDropDown}
                                           options={[{
                                               label: intl.formatMessage({ id: 'label.inquiry.durationOfVisit.4hours' }),
                                               value: 'label.inquiry.durationOfVisit.4hours'
                                           }, {
                                               label: intl.formatMessage({ id: 'label.inquiry.durationOfVisit.8hours' }),
                                               value: 'label.inquiry.durationOfVisit.8hours'
                                           }, {
                                               label: intl.formatMessage({ id: 'label.inquiry.durationOfVisit.12hours' }),
                                               value: 'label.inquiry.durationOfVisit.12hours'
                                           }]}
                                           validate={required}
                                           searchable={false}
                                    />
