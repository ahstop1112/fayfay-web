...
export class GeneralInquiryForm extends Component {
    static propTypes = {
    ...
    submitHandler = values => {
        if (!this.state.captchaResponse) {
            ...
            this.setState(
                { resetCaptcha: true },
                () => postFormData(`/public/activity/email/inquiry/general?langId=${langId}&g-recaptcha-response=${this.state.captchaResponse}`, submitData, form, 'post', true));
        }
    };
