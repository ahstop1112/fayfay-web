...
export class HoneymoonInquiryForm extends Component {
    static propTypes = {
    ...
    submitHandler = values => {
        if (!this.state.captchaResponse) {
            ...
            const submitData = {
                ...
                numOfCompanion: Number(values.numOfCompanion),
                numOfRoom: Number(values.numOfRoom),
                hotelRating: values.hotelRating,
                specialRequest: values.specialRequest
            };

            this.setState(
                { resetCaptcha: true },
                () => postFormData(`/public/activity/email/inquiry/honeymoon?langId=${langId}&g-recaptcha-response=${this.state.captchaResponse}`, submitData, form, 'post', true));
        }
    };
                    ...
                    <div className="greybox activity">
                        ...
                        <div className="row">
                            ...
                            <div className="col-md-6">
                                <div className="form-group">
                                    <label>
                                        <FormattedMessage id="inquiry.numberOfCompanion"/>
                                    </label>
                                    <Field
                                        name="numOfCompanion"
                                        type="number"
                        ...
                        <div className="row">
                            ...
                            <div className="col-md-6">
                                <div className="form-group">
                                    <label>
                                        <FormattedMessage id="inquiry.hotelRating"/>{' '}
                                        <span className="required">*</span>
                                    </label>
                                    <Field name={`hotelRating`}
                                           component={AdvancedDropDown}
                                           options={[{
                                               label: intl.formatMessage({ id: 'label.inquiry.hotelRating.firstClass' }),
                                               value: 'label.inquiry.hotelRating.firstClass'
                                           }, {
                                               label: intl.formatMessage({ id: 'label.inquiry.hotelRating.superior' }),
                                               value: 'label.inquiry.hotelRating.superior'
                                           }, {
                                               label: intl.formatMessage({ id: 'label.inquiry.hotelRating.deluxeClass' }),
                                               value: 'label.inquiry.hotelRating.deluxeClass'
                                           }, {
                                               label: intl.formatMessage({ id: 'label.inquiry.hotelRating.no.need' }),
                                               value: 'label.inquiry.hotelRating.no.need'
                                           }]}
                                           validate={required}
                                           searchable={false}
                                    />
...
})(injectIntl(HoneymoonInquiryForm));
