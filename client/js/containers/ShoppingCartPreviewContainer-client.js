...
import ShoppingCartPreviewContainer from './ShoppingCartPreviewContainer';
...
if (document.getElementById('shopping-cart-preview-container')) {
    hydrate(
        <IntlWrapper store={store} locale={data.lang} messages={data.translations}>
            <ShoppingCartPreviewContainer/>
        </IntlWrapper>,
        document.getElementById('shopping-cart-preview-container')
    );
}
