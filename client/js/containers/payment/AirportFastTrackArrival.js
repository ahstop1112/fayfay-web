...
class AirportFastTrackArrival extends Component {
    static propTypes = {
                                ...
                                <div className="col-sm-12">
                                    <div className="form-group">
                                        <Field className="radio-search-label" name={`${field}.check`}
                                               ...
                                               label={<FormattedHTMLMessage id="payment.fastTrackArrivalRemark"
                                                                            values={{ link: '/category/visa-sim-card/visa-on-arrival' }}/>}/>
                                    </div>
                                </div>
                            </div>
                        )}
...
export default injectIntl(AirportFastTrackArrival);
