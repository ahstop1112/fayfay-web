$(document).ready(function () {
    ...
    const $campaign = $('#one-year-anniversary');
    ...
    function floatingIcons(scrollTop) {
        ...
        for (let index = 0; index < $sections.length; index++) {
            ...
            if (index === 0) {
                $sectionsTitleTop[0] = $('.section-experience.section' + index).position().top + 30;
                $sectionsBottom[0] = $sectionsTitleTop[0] + $sectionsHeight[0] / 2;
            } else {
                $sectionsTitleTop[index] = $('.section-experience.section' + index).position().top + 30;
