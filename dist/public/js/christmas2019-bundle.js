 ...
 */
!function(t){t.fn.snowit=function(a){var e=t('<div class="lis-flake" />').css({top:"-50px",position:"absolute"}).html("<i class=\"far fa-snowflake\"></i>"),n=t(document).height();documentWidth=t(document).width()-50,defaults={minSize:10,maxSize:20,total:25,speed:n/105,flakeColor:"#FFFFFF"},a=t.extend({},defaults,a),inStyle="<style>body { position: relative; }.lis-flake { position: absolute; color:#ff0000;}.lis-flake:nth-child(odd) {-moz-animation:snow1 "+a.speed+"s linear infinite;-webkit-animation:snow1 "+a.speed+"s linear infinite;animation:snow1 "+a.speed+"s linear infinite}.lis-flake:nth-child(even) {-moz-animation:snow2 "+(a.speed-a.speed/8)+"s linear infinite;-webkit-animation:snow2 "+(a.speed-a.speed/8)+"s linear infinite;animation:snow2 "+(a.speed-a.speed/8)+"s linear infinite}@-moz-keyframes snow1{0%{-moz-transform:translate(-20, 0);opacity:1}100%{-moz-transform:translate(20px, "+n+"px);opacity:0}}@-webkit-keyframes snow1{0%{-webkit-transform:translate(-20, 0);opacity:1}100%{-webkit-transform:translate(20px, "+n+"px);opacity:0}}@keyframes snow1{0%{transform:translate(-20, 0);opacity:1}100%{transform:translate(20px, "+n+"px);opacity:0}}@-moz-keyframes snow2{0%{-moz-transform:translate(0, 0);opacity:1}100%{-moz-transform:translate(0, "+n+"px);opacity:0.2}}@-webkit-keyframes snow2{0%{-webkit-transform:translate(0, 0);opacity:1}100%{-webkit-transform:translate(0, "+n+"px);opacity:0.2}}@keyframes snow2{0%{transform:translate(0, 0);opacity:1}100%{transform:translate(0, "+n+"px);opacity:0.2}}</style>";var i=function(){var i=Math.random()*documentWidth-20,o=0-(Math.random()*n-40);startOpacity=.8*Math.random(),num=parseInt(t(".lis-flake").length)+1,sizeFlake=a.minSize+Math.random()*a.maxSize,e.attr("num",num).clone().appendTo("body").css({left:i,top:o,opacity:startOpacity,"font-size":sizeFlake,color:a.flakeColor})};t("head").append(inStyle);for(var o=1;o<=a.total;o++)i()}}(jQuery);
